...
public static class AppConstants
{
    ...
    public const string ConfigFileNameEnhancedPtc = "settings.ui.enhanced.ptc.json";
    ...
    public static string GetUIConfigPath(GameEdition edition)
    {
        ...
        var file = edition switch
        {
            ...
            GameEdition.EnhancedPtc => ConfigFileNameEnhancedPtc,
            _ => ConfigFileName
        };
