...
namespace Trebuchet.Assets {
    ...
    public class Resources {
        ...
        public static string ConsoleNoLocalServer => ResourceManager.GetString("ConsoleNoLocalServer", resourceCulture);
        public static string ConsoleRunning => ResourceManager.GetString("ConsoleRunning", resourceCulture);
        public static string ConsoleOnline => ResourceManager.GetString("ConsoleOnline", resourceCulture);
        public static string ConsoleRconDisabled => ResourceManager.GetString("ConsoleRconDisabled", resourceCulture);
        public static string NoSyncProfile => ResourceManager.GetString("NoSyncProfile", resourceCulture);

        public static string EnhancedPtc => ResourceManager.GetString("EnhancedPtc", resourceCulture);
        ...
        /// <summary>
        ///   Looks up a localized string similar to Configure the app to start on the current user session login, for this specific build of the game. Legacy, Enhanced and Enhanced PTC each have their own setting. Game build selection will therefore be skipped..
        /// </summary>
